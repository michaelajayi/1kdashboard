...
function DashboardCard11() {
  ...
  const chartData = {
    ...
    datasets: [
      {
        label: 'Having difficulties booking a ticket',
        data: [131],
      ...
      {
        label: 'Can\' make payments with Visa Card',
        data: [100],
      ...
      {
        label: 'Really satisfied about the user-friendliness of the app',
        data: [81],
      ...
      {
        label: 'I love the transparency of the system',
        data: [65],
  ...
  return (
    <div className="col-span-full xl:col-span-6 bg-white shadow-lg rounded-sm border border-gray-200">
      <header className="px-5 py-4 border-b border-gray-100">
        <h2 className="font-semibold text-gray-800">Customer Reviews</h2>
      </header>
