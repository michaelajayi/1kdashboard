  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-gray-200">
      <div className="px-5 pt-5">
        ...
        <h2 className="text-lg font-semibold text-gray-800 mb-2">Winnings</h2>
        <div className="text-xs font-semibold text-gray-400 uppercase mb-1">Draws</div>
        <div className="flex items-start">
          <div className="text-3xl font-bold text-gray-800 mr-2">₦67,489</div>
