  ...
  return (
    <div className="col-span-full xl:col-span-8 bg-white shadow-lg rounded-sm border border-gray-200">
      <header className="px-5 py-4 border-b border-gray-100">
        <h2 className="font-semibold text-gray-800">Best Performing Agents</h2>
      </header>
      <div className="p-3">
          ...
          <table className="table-auto w-full">
            ...
            <thead className="text-xs uppercase text-gray-400 bg-gray-50 rounded-sm">
              <tr>
                ...
                <th className="p-2">
                  <div className="font-semibold text-center">Referrals</div>
                </th>
                <th className="p-2">
                  <div className="font-semibold text-center">Tickets Sold</div>
                </th>
                <th className="p-2">
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-gray-800">Adekunle Gold</div>
                  </div>
                </td>
                <td className="p-2">
                ...
                <td className="p-2">
                  <div className="text-center">Lagos</div>
                </td>
                <td className="p-2">
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-gray-800">Don Jazzy</div>
                  </div>
                </td>
                <td className="p-2">
                ...
                <td className="p-2">
                  <div className="text-center">Abuja</div>
                </td>
                <td className="p-2">
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-gray-800">Jon Bellion</div>
                  </div>
                </td>
                <td className="p-2">
                ...
                <td className="p-2">
                  <div className="text-center">Port Harcourt</div>
                </td>
                <td className="p-2">
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-gray-800">Tommy Shelby</div>
                  </div>
                </td>
                <td className="p-2">
                ...
                <td className="p-2">
                  <div className="text-center">Kwara</div>
                </td>
                <td className="p-2">
                  <div className="text-center text-light-blue-500">4.2%</div>
                </td>
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-gray-800">Harry Potter</div>
                  </div>
                </td>
                <td className="p-2">
                ...
                <td className="p-2">
                  <div className="text-center">Taraba</div>
                </td>
                <td className="p-2">
