  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-gray-200">
      <div className="px-5 pt-5">
        ...
        <h2 className="text-lg font-semibold text-gray-800 mb-2">Played Tickets</h2>
        ...
        <div className="flex items-start" style={{marginBottom: '2rem'}}>
          <div className="text-3xl font-bold text-gray-800 mr-2">#78</div>
          <div className="text-sm font-semibold text-white px-1.5 bg-green-500 rounded-full">+14% hourly</div>  
        </div>
      </div>
      </div>
  );
