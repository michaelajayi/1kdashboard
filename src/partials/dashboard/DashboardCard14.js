  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-gray-200">
      <div className="px-5 pt-5">
        ...
        <h2 className="text-lg font-semibold text-gray-800 mb-2">Agents</h2>
        <div className="text-xs font-semibold text-gray-400 uppercase mb-1">Approved</div>
        <div className="flex items-start" style={{marginBottom: '2rem'}}>
          <div className="text-3xl font-bold text-gray-800 mr-2">#5,200</div>
          {/* <div className="text-sm font-semibold text-white px-1.5 bg-yellow-500 rounded-full">+14% monthly</div>   */}
        </div>
      </div>
      </div>
  );
